...
inimesed=["Alex","Dima","Kolja","Aleksandr","Petja"]
while True:
    print(inimesed)
    print(palgad)
    print()
    ...
    if menu==0:
        ...
        inimesed, palgad=lisa_palgad(inimesed, palgad)
    elif menu==2:
        ...
        iniemsed,palgad=nimi_(inimesed,palgad)
    elif menu==8:
        ...
        inimesed,palgad=kustutada(inimesed,palgad)
    elif menu==14:
        inimesed,palgad=tint(inimesed,palgad)
    elif menu==15:
        inimesed,palgad=aasta(inimesed,palgad)
    elif menu==16:
        inimesed=ümber_nimetada(inimesed)
    else:
